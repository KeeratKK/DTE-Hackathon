...
export const Signup = () => {
    ...
    return(
        <div className="flex justify-center items-center mt-[75px] text-white">
        ...
        <div className="content-container w-[500px] h-[590px] bg-black border-2 border-white rounded-2xl flex-col flex justify-center items-center text-center">
            <div className="w-[420px] flex flex-col gap-5">
                ...
                <p className="text-left text-sm text-gray-500">Already a memeber? <Link className="text-[#958fc1]" to="/login">Login</Link></p>
            </div> 
        </div>
        </div>
    )
