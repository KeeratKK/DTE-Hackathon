...
export const Login = () => {
    ...
    return(
      ...
      <ul className="circles">
        ...
        <div className="content-container w-[500px] h-[590px] rounded-2xl flex-col flex border-2 border-[#87CEEB] text-black justify-center items-center text-center">
            <div className="w-[420px] flex flex-col gap-5">
                ...
                <p className="text-left text-sm text-gray-500">No Account? <Link className="text-[#87CEEB]" to="/signup">Sign Up</Link></p>
            </div> 
        </div>
        </div>
    )
